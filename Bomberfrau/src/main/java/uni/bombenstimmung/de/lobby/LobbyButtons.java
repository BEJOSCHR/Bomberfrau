...
public class LobbyButtons extends MouseActionAreaHandler {
    ...
    /**
     * Inititalisiert alle MAAs der Lobby und definiert via Overwrite restliche
     * Funktionalitäten
     */
	...
	// LOBBY STARTBUTTON
	startLobby = new MouseActionArea((int) (GraphicsHandler.getWidth() * 0.35 - Settings.scaleValue(110)),
		GraphicsHandler.getHeight() / 4 + (GraphicsHandler.getHeight() / 5) * 3, Settings.scaleValue(220),
		Settings.scaleValue(100), MouseActionAreaType.MAA_LOBBY_STARTBUTTON, "START", Settings.scaleValue(40),
		...
		if (isHovered() && LobbyCreate.client.getId() == 0) {
		    ...
		    g.drawRect((int) (GraphicsHandler.getWidth() * 0.35 - Settings.scaleValue(100)),
			    GraphicsHandler.getHeight() / 4 + (GraphicsHandler.getHeight() / 5) * 3,
			    Settings.scaleValue(200), Settings.scaleValue(100));
		    GraphicsHandler.drawCentralisedText(g, Color.GREEN, Settings.scaleValue(40), "START",
			    (int) (GraphicsHandler.getWidth() * 0.35 - Settings.scaleValue(100))
				    + Settings.scaleValue(200) / 2,
			    GraphicsHandler.getHeight() / 4 + (GraphicsHandler.getHeight() / 5) * 3
				    + Settings.scaleValue(100) / 2);
		} else {
		    g.setColor(Color.WHITE);
		    g.drawRect((int) (GraphicsHandler.getWidth() * 0.35 - Settings.scaleValue(100)),
			    GraphicsHandler.getHeight() / 4 + (GraphicsHandler.getHeight() / 5) * 3,
			    Settings.scaleValue(200), Settings.scaleValue(100));
		    GraphicsHandler.drawCentralisedText(g, Color.WHITE, Settings.scaleValue(40), "START",
			    (int) (GraphicsHandler.getWidth() * 0.35 - Settings.scaleValue(100))
				    + Settings.scaleValue(200) / 2,
			    GraphicsHandler.getHeight() / 4 + (GraphicsHandler.getHeight() / 5) * 3
				    + Settings.scaleValue(100) / 2);
	...
	// LOBBY EXITBUTTON
	exitLobby = new MouseActionArea((int) (GraphicsHandler.getWidth() * 0.65 - Settings.scaleValue(110)),
		GraphicsHandler.getHeight() / 4 + (GraphicsHandler.getHeight() / 5) * 3, Settings.scaleValue(220),
		Settings.scaleValue(100), MouseActionAreaType.MAA_LOBBY_STARTBUTTON,
		LanguageHandler.getLLB(LanguageBlockType.LB_OPTIONS_BTN).getContent(), Settings.scaleValue(40),
		...
		if (LobbyCreate.client.isHost()) {
			...
			ConsoleHandler.print(
				"Server disposed " + LobbyCreate.client.getAcceptor().isDisposed() + " ... ",
				MessageType.BACKEND);
		    } else {
			LobbyCreate.client.getAcceptor().dispose();
		    }
	...
	mapleft = new MouseActionArea(xPlayer1Left, yPlayerMap, 45, 44, MouseActionAreaType.MAA_LOBBY_PFEILBUTTON_LEFT,
		"Pfeil", 20, Color.DARK_GRAY, Color.ORANGE) { // Diese Werte sind belanglos, da ich die in draw sowieso
							      // überschreibe und nicht brauche
	    @Override
	    public void performAction_LEFT_RELEASE() {
	    ...
	    public void draw(Graphics g) {
		if (isHovered()) {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(),
			    xPlayer1Left - Settings.scaleValue(5),
			    yPlayerMap - (int) (GraphicsHandler.getHeight() * 0.003), Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(), xPlayer1Left,
			    yPlayerMap, Settings.scaleValue(60), Settings.scaleValue(60), null);
		}
	    }
	};

	// LOBBY RIGHT Button fuer Pfeil fuer Timer -> MAA_LOBBY_PFEILBUTTON_RIGHT
	mapright = new MouseActionArea(GraphicsHandler.getWidth() / 8 + Settings.scaleValue(150), yPlayerMap, 45, 44, // Diese
														      // Werte
														      // sind
														      // nicht
														      // sichtbar,
	    ...
	    public void draw(Graphics g) {
		if (isHovered()) {
		    // Die y Koordinate -3, weil ja von oben links das Bild geprinted wird und der
		    // Button so leicht nach unten verschoben wird
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_RIGHT).getImage(),
			    xPlayer1Right - Settings.scaleValue(5),
			    yPlayerMap - (int) (GraphicsHandler.getHeight() * 0.003), Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_RIGHT).getImage(), xPlayer1Right,
			    yPlayerMap, Settings.scaleValue(60), Settings.scaleValue(60), null);
		}
	    }
	};
	...
	timerleft = new MouseActionArea(xPlayer1Left, yPlayerTimer, 45, 44,
		MouseActionAreaType.MAA_LOBBY_PFEILBUTTON_LEFT, "Pfeil", 20, Color.DARK_GRAY, Color.ORANGE) { // Diese
													      // Werte
													      // sind
													      // belanglos,
													      // da ich
		...
		ConsoleHandler.print(" timerchoice = " + timerchoice + ", timer = " + timer[timerchoice],
			MessageType.LOBBY);
		...
		if (isHovered()) {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(),
			    xPlayer1Left - Settings.scaleValue(5),
			    yPlayerTimer - (int) (GraphicsHandler.getHeight() * 0.003), Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(), xPlayer1Left,
			    yPlayerTimer, Settings.scaleValue(60), Settings.scaleValue(60), null);
		}
	    }
	};

	// LOBBY RIGHT Button fuer Pfeil fuer Timer -> MAA_LOBBY_PFEILBUTTON_RIGHT
	timerright = new MouseActionArea(GraphicsHandler.getWidth() / 8 + Settings.scaleValue(150), yPlayerTimer, 45,
		44, // Diese Werte sind nicht sichtbar, aber das sind die Werte wo ich dann klicke
		MouseActionAreaType.MAA_LOBBY_PFEILBUTTON_RIGHT, "Pfeil", 20, Color.DARK_GRAY, Color.ORANGE) {
	    @Override
	    public void performAction_LEFT_RELEASE() {
	...
	// PLAYER 1 LEFT
	player1left = new MouseActionArea(xPlayer1Left, yPlayer, 45, 44, MouseActionAreaType.MAA_LOBBY_PFEILBUTTON_LEFT,
		"Pfeil", 20, Color.DARK_GRAY, Color.ORANGE) {
	    @Override
	    public void performAction_LEFT_RELEASE() {
		...
		if (isHovered()) {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(),
			    xPlayer1Left - Settings.scaleValue(5), yPlayer, Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(), xPlayer1Left,
			    yPlayer, Settings.scaleValue(60), Settings.scaleValue(60), null);
		}
	    }
	};
	...
	player1right = new MouseActionArea(xPlayer1Right, yPlayer, 45, 44,
		...
		if (isHovered()) {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_RIGHT).getImage(), xPlayer1Right,
			    yPlayer - (int) (GraphicsHandler.getWidth() * 0.0015), Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_RIGHT).getImage(), xPlayer1Right,
			    yPlayer, Settings.scaleValue(60), Settings.scaleValue(60), null);
	...
	// PLAYER 2 LEFT
	player2left = new MouseActionArea(xPlayer2Left, yPlayer, 45, 44, MouseActionAreaType.MAA_LOBBY_PFEILBUTTON_LEFT,
		"Pfeil", 20, Color.DARK_GRAY, Color.ORANGE) {
	    @Override
	    public void performAction_LEFT_RELEASE() {
		...
		if (isHovered()) {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(),
			    xPlayer2Left - Settings.scaleValue(5), yPlayer, Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(), xPlayer2Left,
			    yPlayer, Settings.scaleValue(60), Settings.scaleValue(60), null);
		}
	    }
	};
	...
	player2right = new MouseActionArea(xPlayer2Right, yPlayer, 45, 44,
	    ...
	    public void draw(Graphics g) {
		if (isHovered()) {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_RIGHT).getImage(), xPlayer2Right,
			    yPlayer - (int) (GraphicsHandler.getWidth() * 0.0015), Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_RIGHT).getImage(), xPlayer2Right,
	...
	// PLAYER 3 LEFT
	player3left = new MouseActionArea(xPlayer3Left, yPlayer, 45, 44, MouseActionAreaType.MAA_LOBBY_PFEILBUTTON_LEFT,
		"Pfeil", 20, Color.DARK_GRAY, Color.ORANGE) {
	    @Override
	    public void performAction_LEFT_RELEASE() {
		...
		if (isHovered()) {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(),
			    xPlayer3Left - Settings.scaleValue(5), yPlayer, Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(), xPlayer3Left,
			    yPlayer, Settings.scaleValue(60), Settings.scaleValue(60), null);
		}
	    }
	};
	...
	player3right = new MouseActionArea(xPlayer3Right, yPlayer, 45, 44,
	    ...
	    public void draw(Graphics g) {
		if (isHovered()) {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_RIGHT).getImage(), xPlayer3Right,
			    yPlayer - (int) (GraphicsHandler.getWidth() * 0.0015), Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_RIGHT).getImage(), xPlayer3Right,
	...
	// PLAYER 4 LEFT
	player4left = new MouseActionArea(xPlayer4Left, yPlayer, 45, 44, MouseActionAreaType.MAA_LOBBY_PFEILBUTTON_LEFT,
		"Pfeil", 20, Color.DARK_GRAY, Color.ORANGE) {
	    @Override
	    public void performAction_LEFT_RELEASE() {
		...
		if (isHovered()) {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(),
			    xPlayer4Left - Settings.scaleValue(5), yPlayer, Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_LEFT).getImage(), xPlayer4Left,
			    yPlayer, Settings.scaleValue(60), Settings.scaleValue(60), null);
		}
	    }
	};
	...
	player4right = new MouseActionArea(xPlayer4Right, yPlayer, 45, 44,
	    ...
	    public void draw(Graphics g) {
		if (isHovered()) {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_RIGHT).getImage(), xPlayer4Right,
			    yPlayer - (int) (GraphicsHandler.getWidth() * 0.0015), Settings.scaleValue(70),
			    Settings.scaleValue(70), null);
		} else {
		    g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_ARROW_RIGHT).getImage(), xPlayer4Right,
	...
	// Player 2
	player2check = new MouseActionArea(xPlayer2Left + Settings.scaleValue(140),
		yPlayerMap - Settings.scaleValue(50), Settings.scaleValue(130), Settings.scaleValue(80),
		MouseActionAreaType.MAA_LOBBY_CHECKMARK,
		LanguageHandler.getLLB(LanguageBlockType.LB_LOBBY_READY).getContent(), Settings.scaleValue(30),
	    ...
	    @Override
	    public boolean isActiv() {
		if (GraphicsHandler.getDisplayType() == DisplayType.LOBBY && LobbyCreate.numberOfMaxPlayers >= 2
			&& LobbyCreate.player[1] != null) {
		    return true;
		} else {
		    return false;
		}
		...
		if (LobbyCreate.player[1] != null) {
			...
			g.drawRect(xPlayer2Left + Settings.scaleValue(166), yPlayerMap - Settings.scaleValue(50),
				Settings.scaleValue(80), Settings.scaleValue(80));
		    }

		    if (LobbyCreate.player[1].getisReady() == true) {
			g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_CHECKMARK).getImage(),
				xPlayer2Left + Settings.scaleValue(172), yPlayerMap - Settings.scaleValue(46),
				Settings.scaleValue(70), Settings.scaleValue(70), null);
		    } else {
			g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_CROSS).getImage(),
				xPlayer2Left + Settings.scaleValue(174), yPlayerMap - Settings.scaleValue(46),
				Settings.scaleValue(70), Settings.scaleValue(70), null);
		    }
		}
	    }
	...
	// Player 3
	player3check = new MouseActionArea(xPlayer3Left + Settings.scaleValue(140),
		yPlayerMap - Settings.scaleValue(50), Settings.scaleValue(130), Settings.scaleValue(80),
		MouseActionAreaType.MAA_LOBBY_CHECKMARK,
		LanguageHandler.getLLB(LanguageBlockType.LB_LOBBY_READY).getContent(), Settings.scaleValue(30),
		Color.DARK_GRAY, Color.GREEN) {
	    ...
	    @Override
	    public boolean isActiv() {
		if (GraphicsHandler.getDisplayType() == DisplayType.LOBBY && LobbyCreate.numberOfMaxPlayers >= 3
			&& LobbyCreate.player[2] != null) {
		    return true;
		} else {
		    return false;
		}
		...
		if (LobbyCreate.player[2] != null) {
			...
			g.drawRect(xPlayer3Left + Settings.scaleValue(166), yPlayerMap - Settings.scaleValue(50),
				Settings.scaleValue(80), Settings.scaleValue(80));
		    }

		    if (LobbyCreate.player[2].getisReady() == true) {
			g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_CHECKMARK).getImage(),
				xPlayer3Left + Settings.scaleValue(172), yPlayerMap - Settings.scaleValue(46),
				Settings.scaleValue(70), Settings.scaleValue(70), null);
		    } else {
			g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_CROSS).getImage(),
				xPlayer3Left + Settings.scaleValue(174), yPlayerMap - Settings.scaleValue(46),
				Settings.scaleValue(70), Settings.scaleValue(70), null);
		    }
		}
	    }
	...
	// Player 4
	player4check = new MouseActionArea(xPlayer4Left + Settings.scaleValue(140),
		yPlayerMap - Settings.scaleValue(50), Settings.scaleValue(130), Settings.scaleValue(80),
		MouseActionAreaType.MAA_LOBBY_CHECKMARK,
		LanguageHandler.getLLB(LanguageBlockType.LB_LOBBY_READY).getContent(), Settings.scaleValue(30),
		Color.DARK_GRAY, Color.GREEN) {
	    ...
	    @Override
	    public boolean isActiv() {
		if (GraphicsHandler.getDisplayType() == DisplayType.LOBBY && LobbyCreate.numberOfMaxPlayers == 4
			&& LobbyCreate.player[3] != null) {
		    return true;
		} else {
		    return false;
		}
		...
		if (LobbyCreate.player[3] != null) {
			...
			g.drawRect(xPlayer4Left + Settings.scaleValue(166), yPlayerMap - Settings.scaleValue(50),
				Settings.scaleValue(80), Settings.scaleValue(80));
		    }

		    if (LobbyCreate.player[3].getisReady() == true) {
			g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_CHECKMARK).getImage(),
				xPlayer4Left + Settings.scaleValue(172), yPlayerMap - Settings.scaleValue(46),
				Settings.scaleValue(70), Settings.scaleValue(70), null);
		    } else {
			g.drawImage(ImageHandler.getImage(ImageType.IMAGE_LOBBY_CROSS).getImage(),
				xPlayer4Left + Settings.scaleValue(174), yPlayerMap - Settings.scaleValue(46),
				Settings.scaleValue(70), Settings.scaleValue(70), null);
		    }
		}
	    }
	...
	ip_nbr = new MouseActionArea((int) (GraphicsHandler.getWidth() * 0.14),
		(int) (GraphicsHandler.getHeight() * 0.03), (int) (GraphicsHandler.getWidth() * 0.17),
		(int) (GraphicsHandler.getHeight() * 0.05), MouseActionAreaType.MAA_LOBBY_IP_NBR, "",
		Settings.scaleValue(30), Color.DARK_GRAY, Color.GREEN) {
	    @Override
	    public void performAction_LEFT_RELEASE() {
		// ConsoleHandler.print("IP Number = " + LobbyCreate.client.hostGetPublicIP(),
		// MessageType.LOBBY);
		StringSelection stringSelection = new StringSelection(LobbyCreate.client.hostGetPublicIP());
		Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();
		clipboard.setContents(stringSelection, null);
		ConsoleHandler.print("Copied <" + LobbyCreate.client.hostGetPublicIP() + "> to Clipboard",
			MessageType.LOBBY);
	    }
