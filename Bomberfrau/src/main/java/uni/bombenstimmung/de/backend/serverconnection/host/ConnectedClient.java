...
public class ConnectedClient extends IoHandlerAdapter {
	...
	case 010:
	    session.closeNow();
	    break;
	// 100 = Position eines Spieler wird gesendet und an alle anderen Spieler
	// gebroadcastet.
	...
	case 100:
	    ...
	    break;
	// 101 = Position einer gesetzen Bombe wird gesendet und an alle anderen Spieler
	// gebroadcastet.
...
//		    	ConsoleHandler.print("Der case 502 wurde aufgerufen vom Backend", MessageType.LOBBY);
	...
	// alle schon existierenen Player erstmal einfügt
