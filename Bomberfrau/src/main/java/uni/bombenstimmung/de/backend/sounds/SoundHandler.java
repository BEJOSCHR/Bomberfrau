...
//	}
     ...
     * @param volumeModifier - Der modifier [0.02D heiï¿½t also das das volume um
     *                       diesen wert erhï¿½ht wird, -0.02D das er geringer wird]
    ...
    /**
     * Gibt den Sound zum zugehï¿½rigen Type zurï¿½ck (Wenn richtig geladen gibt es
     * fï¿½r jeden Type einen Sound)
     * 
     * @param type - Der Type der gesucht wird
     * @see SoundType
     * @return Der {@link LoadedSound} der zum Type gehï¿½rt, wenn keiner gefunden
     *         wird dann null
     */
    ...
    /**
     * Gibt die Sounds zur zugehï¿½rigen Category zurï¿½ck (Wenn richtig geladen
     * gibt es fï¿½r jede Category einen Sound)
     * 
     * @param category - Die Category die gesucht wird
     * @see SoundCategory
     * @return Liste von {@link LoadedSound} die zur Category gehï¿½ren, wenn keiner
