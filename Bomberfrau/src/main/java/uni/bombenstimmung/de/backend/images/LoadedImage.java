...
public class LoadedImage {
     ...
     * 
     * @param name - Der Name des Images (zb: foler/name.png wobei images als ordner
     *             immer automatisch davor steht)
     * @param type - Der Type dem das Image zugeordnet wird (und über das es
     *             identifziert wird)
     */
    ...
    /**
     * Repräsentiert ein Image (Wird automatisch auf die angegebene Größen
     * zugeschnitten)
     * 
     * @param name   - Der Name des Images (zb: foler/name.png wobei images als
     *               ordner immer automatisch davor steht)
     * @param type   - Der Type dem das Image zugeordnet wird (und über das es
     *               identifziert wird)
	...
	try {
	    this.image = ImageIO
		    .read(BomberfrauMain.class.getClassLoader().getResourceAsStream(ImageHandler.PATH + name));
	    return true;
	} catch (IOException e) {
