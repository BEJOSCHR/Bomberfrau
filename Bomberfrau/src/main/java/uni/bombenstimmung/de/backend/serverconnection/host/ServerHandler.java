...
public class ServerHandler extends IoHandlerAdapter {
     ...
     * 
     * @param server - Beim erstellen eines neuen ConnectedClient wird dieser dem
    ...
    /**
     * Diese Methode wird immer automatisch beim Abbau der Session aufgerufen.
     * Daraufhin wird der Client aus der HashMap entfernt.
     * 
	...
	if (Integer.parseInt(parts[0]) != 003) {
	    ...
	    ConsoleHandler.print("Server: Message received from Client " + remoteAddress + ": " + message.toString(),
		    MessageType.BACKEND);
