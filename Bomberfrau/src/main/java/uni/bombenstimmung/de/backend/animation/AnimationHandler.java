...
public class AnimationHandler {
	...
	if (tickTimer == null) {
	    ...
	    ConsoleHandler.print("Couldn't init/start TickTimer, because there is already one running!",
    ...
    /**
     * Fügt die übergebenen Animation zur runningAnimation Liste hinzu (Wird
     * eigentlich nur aus der Animation aufgerufen)
     * 
    ...
    /**
     * Stoppt alle derzeit laufenden Animationen (Nützlich bei Szenene wechseln bei
     * denen dauerhafte Animationen enden sollen)
     */
