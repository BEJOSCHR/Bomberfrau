...
public class LoadedSound {
     ...
     * 
     * @param name     - Der Name des Sounds (zb: foler/name.wav wobei sounds als
     *                 ordner immer automatisch davor steht)
     * @param type     - Der Type dem der Sound zugeordnet wird (und über den er
     *                 identifziert wird)
     * @param category - Die {@link SoundCategory} die der Sound zugeordnet wird
     * @param volume   - Die Lautstärke des Sounds [0.02 bis 0.1 sind ganz gute
     *                 Lautstärken]
     */
