...
public class LanguageHandler {
	...
	public static void initLLBs() {
		...
		String[] intro_skip = {"<<  Click to skip  >>", "<< Klicken zum �berspringen >>"};
		...
		String[] menu_info2 = {"invalid IP", "ung�ltige IP"};
		...
		String[] options_txt1 = {"Resolution:", "Aufl�sung:"};
		...
		String[] options_txt2 = {"Volume Music:", "Lautst�rke Musik:"};
		new LoadedLanguageBlock(LanguageBlockType.LB_OPT_TXT2, options_txt2);
		String[] options_txt3 = {"Volume Sound:", "Lautst�rke Sound:"};
		...
		String[] options_btn = {"BACK", "ZUR�CK"};
		...
		String[] bad_res = {"resolution to high - switching to fullscreen.", "Die Aufl�sung ist zu gross - Wechsel zu Vollbild."};
