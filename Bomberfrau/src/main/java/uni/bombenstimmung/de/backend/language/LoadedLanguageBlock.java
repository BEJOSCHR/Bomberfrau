...
public class LoadedLanguageBlock {
    ...
    /**
     * Repräsentiert einen SprachBlock, wichtig bei der Initialisierung von Content
     * ist die Reihenfole, siehe dafür {@link LanguageType}!
     * 
     * @param type    - Der Type der diesen LBB identifiziert
     * @param content - Die eigentlichen Sprachdaten für die jeweilige Sprache
     *                [0=ENGLISH, 1=GERMAN, ...]
