...
public class Label extends JLabel {
	...
	protected void paintComponent(Graphics g) {
		...
		case AFTERGAME:
			...
			GraphicsHandler.drawLeftText(g, gold.darker(), 70, LanguageHandler.getLLB(LanguageBlockType.LB_AFTERGAME_RANKING_1).getContent(), GraphicsHandler.getWidth()*1/4, GraphicsHandler.getHeight()*2/8);
			GraphicsHandler.drawLeftText(g, gold.darker(), 70, LanguageHandler.getLLB(LanguageBlockType.LB_AFTERGAME_RANKING_2).getContent(), GraphicsHandler.getWidth()*1/4, GraphicsHandler.getHeight()*3/8);
			GraphicsHandler.drawLeftText(g, gold.darker(), 70, LanguageHandler.getLLB(LanguageBlockType.LB_AFTERGAME_RANKING_3).getContent(), GraphicsHandler.getWidth()*1/4, GraphicsHandler.getHeight()*4/8);
			GraphicsHandler.drawLeftText(g, gold.darker(), 70, LanguageHandler.getLLB(LanguageBlockType.LB_AFTERGAME_RANKING_4).getContent(), GraphicsHandler.getWidth()*1/4, GraphicsHandler.getHeight()*5/8);
			break;
		default:
